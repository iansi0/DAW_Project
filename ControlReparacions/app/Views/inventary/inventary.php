  ...
  <div class="flex justify-between items-center mb-1">
    ...
    <div class="flex gap-3 items-center center">
      ...
      <a href="<?= base_url('inventary/add') ?>">
        <button id='add-ticket' class="bg-primario text-white px-2 py-1 border border-terciario-4 hover:bg-green-700 cursor-pointer hover:text-secundario rounded-lg transition hover:ease-in ease-out text-base font-semibold duration-250"><?=lang('buttons.add')?> <?=lang('titles.inventory_2') ?></button>
      </a>
    </div>
    ...
    <div class="relative">
      ...
      <ul class="rounded-lg flex flex-col shadow-lg border border-primario text-base text-terciario-4 " aria-labelledby="dropdownDefaultButton">
          ...
          <!-- Export CSV  -->
          <li>
            <a href="<?= base_url('inventary/export/csv') ?>" class="rounded-t-md transition hover:ease-in ease-out duration-250 block px-4 py-2 hover:bg-primario hover:text-secundario">
          ...
          <!-- Plantilla CSV  -->
          <li>
            <a href="<?= base_url('inventary/dowloadCSV') ?>" class="rounded-b-md transition hover:ease-in ease-out duration-250 block px-4 py-2 hover:bg-primario hover:text-secundario">Plantilla CSV</a>
          </li>
