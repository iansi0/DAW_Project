            ...
            <div class="grid grid-cols-12 mt-2 p-4">
                ...
                <div class="col-span-12 grid grid-cols-12">
                    ...
                    <div class="col-span-2 grid-cols-12 text-left px-2">
                        ...
                        <select name="active" id="active" class="border-2 border-terciario-1 w-full px-2 py-3 rounded hover:bg-secundario transition hover:ease-in ease-out duration-150">
                ...
                <div class="col-span-12 grid grid-cols-12 mt-5 mb-3">
                    ...
                    <div class="col-span-2 grid-cols-12 text-left px-2">
                        ...
                        <input type="text" name="phone" class="border-2 border-terciario-1 w-full px-2 py-3 rounded hover:bg-secundario transition hover:ease-in ease-out duration-150"></input>
                        <?php
                    ...
                    <div class="col-span-6 grid-cols-12 text-left px-2">
                        ...
                        <input type="text" name="adress" class="border-2 border-terciario-1 w-full px-2 py-3 rounded hover:bg-secundario transition hover:ease-in ease-out duration-150">
                        <?php
