    ...
    <aside class="flex flex-col gap-10">
        ...
        <form action="<?= base_url('config/institute') ?>" method="POST" class="flex flex-col gap-5 px-10 py-5 border-2 border-black rounded-lg">
            ...
            <div class="flex flex-col mt-5">
                ...
                <input type="email" value="<?= $institute['correu_persona_contacte'] ?>" name="email" class="border-2 border-terciario-1 px-2 py-3 rounded hover:bg-secundario transition hover:ease-in ease-out duration-150 ">
            </div>
