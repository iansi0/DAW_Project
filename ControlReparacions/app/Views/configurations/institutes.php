...
<main class="h-full">
    ...
    <aside class="grid grid-cols-12 gap-3">
        <div class="col-span-12 shadow-xl border-b grid grid-cols-12 border-primario rounded-t-xl">
            ...
            <!-- info insti  -->
            <form id="form" action="<?= base_url('config/institute') ?>" method="POST" class="col-span-12 grid grid-cols-12 mt-2">
                <div class="col-span-12 grid grid-cols-12 px-4">
                    ...
                    <div class="col-span-3 grid grid-cols-12 mt-3">
                        <div class="col-span-12 grid-cols-12 text-left px-2">
                            <p class="font-semibold text-primario"><?=mb_strtoupper(lang('forms.code').' '.mb_strtoupper(lang('titles.ins_2')))?>: </p>
                    ...
                    <div class="grid col-span-12 grid-cols-12 mt-2 p-4">
                        <div class="col-span-12 grid grid-cols-12">
                            <div class="col-span-12 grid-cols-12 text-left px-2">
                                <input type="submit" id="submitButton" value="<?=mb_strtoupper(lang('buttons.save'))?>" class="bg-green-700 w-full  hover:bg-green-500 cursor-pointer text-white px-4 py-2 rounded transition hover:ease-in ease-out duration-250">
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-span-12 shadow-xl border-b grid grid-cols-12 border-primario rounded-t-xl">
            ...
            <div class="col-span-12 grid grid-cols-12 mt-2">
                <div class="col-span-12 grid grid-cols-12 px-4">
                    ...
                    <div class="col-span-2 grid grid-cols-12 mt-3">
                        <div class="col-span-12 grid-cols-12 text-left px-2">
                            <p class="font-semibold text-primario"><?=mb_strtoupper(lang('forms.cp_2'))?>: </p>
                    ...
                    <div class="col-span-12 grid grid-cols-12 mt-3 mb-3">
                        <div class="col-span-12 grid-cols-12 text-left px-2">
                            <p class="font-semibold text-primario"><?=mb_strtoupper(lang('forms.other'))?>: </p>
