...
<section style="view-transition-name: addTicket;" class="container mx-auto px-4 py-8 mt-10 text-base">
    <form action="<?= $ticket['id']; ?>" method="POST" class="flex flex-col gap-20">
        ...
        <div class="flex gap-5">
            ...
            <input type="submit" value="<?= lang("buttons.edit")?>" class="bg-blue-700 hover:bg-blue-500 cursor-pointer text-white px-4 py-2 rounded transition hover:ease-in ease-out duration-250">
