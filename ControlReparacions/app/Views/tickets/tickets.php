      ...
      <div class="relative">
        ...
        <div id="dropdown" class="absolute hidden z-10 w-full  bg-white divide-y divide-gray-100 rounded-lg ">
          ...
          <ul class=" flex flex-col shadow-lg border-2 border-terciario-1 gap-2  text-terciario-4 text-lg" aria-labelledby="dropdownDefaultButton">
            ...
            <!-- Etiquetes PDF  -->
            <li>
              <a href="<?= base_url('tickets/labels?q=' . $search . "&d=" . $filters['device'] . "&c=" . $filters['center'] . "&dt_1=" . $filters['date_ini'] . "&dt_2=" . $filters['date_end'] . "&tm_1=" . $filters['time_ini'] . "&tm_2=" . $filters['time_end'] . "&e=" . $filters['state']) ?>" class="block px-4 py-2 hover:bg-primario hover:text-secundario">Etiquetes PDF</a>
            </li>
