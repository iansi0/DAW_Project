...
<h1 class=" text-center mt-9 bg-primario ml-80 text-5xl" style="margin-top: 9%;">><?=strtoupper(lang('titles.ticket'))?></h1>
...
<section class="w-full">
    <table class="table-auto border border-primario ml-20 ">
        <td class="bg-primario text-white text-center">
        ><?=lang('forms.description')?>
        </td>
...
<section class="-mt-28">
    ...
    <table class="table-auto border border-primario w-8/12 ml-auto -mt-7">
        
        <thead class="bg-primario text-white">
            <tr>
                <th>><?=lang('forms.date')?></th>
                <th>><?=lang('titles.students')?></th>
                <th>Material</th>  <!-- no se donde esta-->
        ...
        <tbody class="text-black">
            <tr>
                <td>25-09-22</td>
                <td>OSCAR VIDAL</td>
                <td>2-RAM, 1-Font alimentació... </td>
                <td>He probat amb un tester si arriba...</td>
            </tr>
            ...
            <tr>
                ...
                <td>OSCAR VIDAL</td>
                <td>2-RAM, 1-Font alimentació...</td>
                <td class=" bg-red-600">[BLOQUEJANT] Disc dur averiat...</td>
            </tr>
            <tr  class="bg-gray-200">
                <td>25-09-22</td>
                <td>OSCAR VIDAL</td>
        ...
        <thead class="bg-primario text-white text-right">
            <tr>
                <td>esto mal</td>
                <td>esto mal</td>
                <td>esto mal</td>
