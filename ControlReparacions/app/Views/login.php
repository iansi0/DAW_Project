...
<body class="h-screen flex flex-col justify-center items-center bg-[#f7f7f9]">
    ...
    <section class="bg-[#ffffff] text-terciario-4 flex flex-col gap-5 items-center border-2 border-secundario rounded-md px-20 py-10">
        ...
        <form class=" flex flex-col gap-5   w-full " method="POST" action="login">
            ...
            <div class="mt-8">
                <div class="relative flex items-center">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="togglePasswordBtn" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-2 cursor-pointer" viewBox="0 0 128 128">
        ...
        <a href="<?= $client ?>" class="px-4 py-2 border flex gap-2 border-slate-700 rounded-lg text-slate-700  hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150">
...
<script>
    ...
    const buttonShow = document.getElementById('togglePasswordBtn');
