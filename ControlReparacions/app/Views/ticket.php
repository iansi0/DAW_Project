...
<button id="add-ticket" class=" bg-primario text-segundario float-right mb-5 px-5 py-2 hover:bg-terciario-4">+ Afegir</button>


<table class="w-full ">
  <thead class=" bg-primario text-segundario">
    <th>Ticket</th>
    <th>ID_Disp</th>
    <th>Type</th>
    <th>Institut</th>
