...
<body class=" flex h-full bg-segundario">
    ...
    <nav id="Sidebar" class="bg-terciario-1 flex flex-col gap-10 py-20 w-20  text-5xl  z-10">


        <a href="<?= base_url('alumnes') ?>" class=" w-20  h-16 overflow-hidden flex items-center text-2xl text-segundario  transition-all ease-in duration-1000 hover:w-56  hover:bg-primario hover:text-white">
            <!-- Imagen ticket-->
        ...
        <button class="hover:z-10">
            <a href="<?= base_url('tickets') ?>" class=" w-20 h-16 overflow-hidden flex items-center text-2xl text-segundario transition-all ease-in duration-300   hover:w-56  hover:bg-primario hover:text-white ">
                <!-- Imagen ticket-->
