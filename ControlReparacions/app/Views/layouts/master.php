...
<body class=" flex h-full">
    ...
    <nav id="Sidebar" class="bg-terciario-2 flex flex-col gap-10 py-20 w-20  text-5xl h-full ">
        ...
        <a href="<?= base_url('alumnes') ?>" class=" w-20  h-16 overflow-hidden flex items-center text-2xl text-primario  transition-all ease-in duration-300  hover:w-56  hover:bg-primario hover:text-white">
            <!-- Imagen ticket-->
        ...
        <button class="hover:z-10">
            <a href="<?= base_url('tickets') ?>" class=" w-20 h-16 overflow-hidden flex items-center text-2xl text-primario transition-all ease-in duration-300   hover:w-56  hover:bg-primario hover:text-white ">
                <!-- Imagen ticket-->
