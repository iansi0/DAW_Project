    ...
    <form action="<?=$student['id_user']?>" method="POST" class="flex flex-col gap-20" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-3 gap-x-2 gap-y-2">
            ...
            <div class="flex flex-col mt-5">
                ...
                <input type="text" name="course" value="<?=$student['curs']?>" class="border-2 border-terciario-1 px-2 py-3 rounded hover:bg-secundario transition hover:ease-in ease-out duration-150 "></input>
                <?php
